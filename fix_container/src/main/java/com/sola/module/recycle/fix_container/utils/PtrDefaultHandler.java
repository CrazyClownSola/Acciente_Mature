...
public abstract class PtrDefaultHandler implements IPullToRefreshHandler {
    ...
    public static boolean checkContentCanBePulledDown(IPullToRefreshContainer frame, View content, View header) {
        return !canChildScrollUp(content);
    }

    @Override
    public boolean checkCanDoRefresh(IPullToRefreshContainer frame, View content, View header) {
