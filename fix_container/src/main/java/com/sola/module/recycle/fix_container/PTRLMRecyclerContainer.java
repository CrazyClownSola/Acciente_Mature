...
import com.sola.module.recycle.fix_container.tools.IPullToRefreshViewContainer;
...
public class PTRLMRecyclerContainer extends LMRecyclerContainer
        implements IPullToRefreshViewContainer {
    ...
    public void setDurationToCloseHeader(int mDurationToCloseHeader) {
        this.mDurationToCloseHeader = mDurationToCloseHeader;
    }

    public void setDurationToClose(int mDurationToClose) {
...
//                }
    ...
    public void autoRefresh(boolean atOnce) {
        ...
        //界面下拉到警戒线
        tryToScrollTo(mOffsetToRefresh, mDurationToCloseHeader);
...
//        invalidate();
    ...
    private void tryScrollBackToTop() {
        if (!isUnderTouch) {
            ...
            tryToScrollTo(POS_START, mDurationToCloseHeader);
        }
    }
