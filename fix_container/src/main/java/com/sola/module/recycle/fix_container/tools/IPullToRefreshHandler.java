...
public interface IPullToRefreshHandler {
     ...
     * @return 是否能进行更新
     */
    boolean checkCanDoRefresh(final IPullToRefreshContainer frame, final View content, final View header);
     ...
     * @param frame 界面
     */
    void onRefreshBegin(final IPullToRefreshContainer frame);
}
