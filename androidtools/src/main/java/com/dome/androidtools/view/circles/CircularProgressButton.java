...
import com.dome.androidtools.R;
...
public class CircularProgressButton extends Button implements Serializable {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mIconLoading = attr.getResourceId(R.styleable.CircularProgressButton_cpb_iconLoading, 0);
    ...
    private void drawIndeterminateProgress(Canvas canvas) {
        if (mAnimatedDrawable == null) {
            ...
            mAnimatedDrawable = new CircularAnimatedDrawable(
                    mColorIndicator, mStrokeWidth, getResources(), mIconLoading);
    ...
    private void drawProgress(Canvas canvas) {
        if (mProgressDrawable == null) {
            ...
            mProgressDrawable = new CircularProgressDrawable(getResources(), size,
